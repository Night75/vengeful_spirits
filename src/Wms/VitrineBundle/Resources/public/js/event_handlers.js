$(function(){
	...
	$('section.page').waypoint(function(event, direction){
		if(direction === "down"){
			var $currentSelected = $(selector + "[href=#" + $(this).attr('id') + "]");
			//var $next = $currentSelected.parent("li").next().children("a");
			if($currentSelected.length){
				$(selector).removeClass("selected").removeAttr("style");
				$currentSelected.removeAttr("style").addClass("selected");
			}
			//$(selector + "[href=#cv]").removeAttr("style").addClass("selected");
		} else {
			var $currentSelected = $(selector + "[href=#" + $(this).attr('id') + "]");
			var $prev = $currentSelected.parent("li").prev().children("a");
			
			if($prev.length){
				$currentSelected.removeClass("selected").removeAttr("style");
				$prev.removeAttr("style").addClass("selected");
			}
		}
	})
	...
	*/
	...
	$(".projet-slider").nSlider({
			items : [".excerpt li", ".gallery li"]
		});
